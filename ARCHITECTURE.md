...
The external `darklab evidence services` command calls the owner-scoped service-evidence API directly. Its focused parser and handler preserve the bounded page for JSON and NDJSON consumers while presenting the same typed fields in text, and they don't grow the main CLI module or load scanner output.
