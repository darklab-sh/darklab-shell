...
| Method | Endpoint | Description |
| -------- | ---------- | ------------- |
| `GET` | `/atlas` | Returns current-session Atlas entity counts by entity type, honoring the orphan-source and suppression filters. |
| `GET` | `/atlas/views` | Lists saved Atlas views for the current session token. |
| `POST` | `/atlas/views` | Saves a named Atlas view with its tab, search, filter, review-state, and project-scope state. |
...
| `GET` | `/atlas/entities` | Returns a paginated current-session entity list, with optional `type`, text search, project, orphan-source, suppression, limit, and offset parameters. |
| `GET` | `/atlas/entities/export` | Downloads current-session Atlas entity rows as CSV or JSONL, honoring optional type, text, project, orphan-source, suppression, and limit filters. |
...
| `GET` | `/atlas/findings` | Returns the paginated Atlas Findings queue with optional text, project, review-state, orphan-source, suppression, limit, and offset filters. |
