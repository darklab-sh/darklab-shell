...
Assessment-batch previews validate every credential-free public probe plan and its digest, hash the complete stable-ordered snapshot, expire after 15 minutes, and return complete items in pages capped at 100 entries and 1 MiB. Creating or reading a preview doesn't create a coordinator or run row.
