...
- external CLI mutation cases pin bounded file and stdin input, exact request bodies, structured conflicts, role failures, stable output, idempotent evidence links, and matching SQLite/PostgreSQL write behavior without multiplying test functions for each command shape
