...
│   │       ├── run_monitor.js  # App-native active-run drawer/sheet controller
...
└── tests/
    ...
    │       ├── run_monitor.test.js # Run Monitor drawer rendering, including active-run resource telemetry
