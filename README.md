...
Expanded Assessment targets also show reviewed next steps for explicit Project service evidence, such as an HTTPS or SSH fingerprint. Uncertain, unsupported, or conflicting service labels don't produce an action, and these read-only hints never start a run.
