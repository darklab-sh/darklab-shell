...
The shell chrome now uses direct DOM construction for the tab headers, history entries, and FAQ limits / allowed-command sections, plus class-based modal wrappers in the template. That reduces string-built fragments without changing the visible UI or the test model above.
