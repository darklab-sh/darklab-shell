...
_MODULE_SIZE_RATCHET = (
    ...
    ModuleSizeBudget("app/services/assessments/command_plans.py", 100, "split-package-ratchet"),
    ModuleSizeBudget("app/services/assessments/command_plans_web.py", 76, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/assessments/version_correlation.py", 100, "split-package-ratchet"),
