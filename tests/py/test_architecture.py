...
_MODULE_SIZE_RATCHET = (
    ...
    ModuleSizeBudget("app/blueprints/projects_verification_actions.py", 154, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/blueprints/api_v1_verification_actions.py", 152, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/assessments/command_plans.py", 89, "split-package-ratchet"),
    ModuleSizeBudget("app/services/assessments/command_plans_web.py", 66, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/assessments/http_profile_material.py", 158, "split-package-ratchet"),
    ModuleSizeBudget("app/services/assessments/http_profile_material_formats.py", 39, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/assessments/recommended_action_profiles.py", 31, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/runs/finalization.py", 990, "split-package-ratchet"),
