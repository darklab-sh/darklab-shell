...
_MODULE_SIZE_RATCHET = (
    ...
    ModuleSizeBudget("app/services/assessments/command_plans.py", 122, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/assessments/http_profile_material.py", 169, "split-package-ratchet"),
