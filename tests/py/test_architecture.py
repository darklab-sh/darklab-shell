...
_MODULE_SIZE_RATCHET = (
    ...
    ModuleSizeBudget("app/services/projects/finding_evidence.py", 317, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/runs/finalization_assessments.py", 66, "split-package-ratchet"),
