...
_API_V1_SERVICE_ALLOWED_FILES = {
    ...
    "openapi_probe_authorization.py",
...
_MODULE_SIZE_RATCHET = (
    ...
    ModuleSizeBudget("app/services/connectors/oast_worker.py", 309, "split-package-ratchet"),
    ModuleSizeBudget(
    ...
    ModuleSizeBudget("app/services/connectors/zap_job_queue.py", 58, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/connectors/zap_worker.py", 382, "split-package-ratchet"),
    ModuleSizeBudget(
    ...
    ModuleSizeBudget("app/blueprints/projects_assessment_oast.py", 168, "split-package-ratchet"),
    ModuleSizeBudget(
    ...
    ModuleSizeBudget("app/blueprints/projects_monitoring.py", 247, "split-package-ratchet"),
    ModuleSizeBudget("app/blueprints/projects_monitoring_risk.py", 65, "split-package-ratchet"),
    ModuleSizeBudget("app/blueprints/projects_packages.py", 391, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/blueprints/api_v1_assessment_oast.py", 171, "split-package-ratchet"),
    ModuleSizeBudget(
    ...
    ModuleSizeBudget("app/blueprints/api_v1_cve_risk.py", 18, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/blueprints/api_v1_osv_result.py", 66, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/api_v1/openapi_cve_risk_feeds.py", 92, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/core/output_command_entities.py", 29, "split-package-ratchet"),
    ModuleSizeBudget("app/core/output_dns_command.py", 107, "split-package-ratchet"),
    ModuleSizeBudget("app/core/output_dns_entities.py", 375, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/api_v1/openapi_probe_authorization.py", 34, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/assessments/probe_authorization.py", 46, "split-package-ratchet"),
    ...
    ModuleSizeBudget(
        "app/services/assessments/profile_catalog_validation.py",
        147,
        "split-package-ratchet",
    ),
    ModuleSizeBudget("app/services/assessments/profile_summaries.py", 27, "split-package-ratchet"),
    ModuleSizeBudget("app/services/assessments/profiles.py", 631, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/assessments/zap_connector.py", 546, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/core/process.py", 1243, "ratchet-only"),
    ...
    ModuleSizeBudget(
        "app/services/assessments/batch/retry_actions.py", 61, "split-package-ratchet"
    ),
    ModuleSizeBudget(
    ...
    ModuleSizeBudget(
        "app/services/assessments/batch/terminal_observability.py",
        73,
        "split-package-ratchet",
    ),
    ModuleSizeBudget(
    ...
    ModuleSizeBudget("app/services/assessments/batch/storage.py", 332, "split-package-ratchet"),
    ...
    ModuleSizeBudget(
        "app/services/cve_risk/osv_external_coordination.py",
        181,
        "split-package-ratchet",
    ),
    ModuleSizeBudget("app/services/cve_risk/osv_external_http.py", 131, "split-package-ratchet"),
    ModuleSizeBudget("app/services/cve_risk/osv_external_state.py", 99, "split-package-ratchet"),
    ...
    ModuleSizeBudget("tools/darklab_cli/src/darklab_cli/__main__.py", 2099, "split-target-phase4"),
    ModuleSizeBudget("tools/darklab_cli/src/darklab_cli/client.py", 336, "split-package-ratchet"),
    ModuleSizeBudget("tools/darklab_cli/src/darklab_cli/errors.py", 49, "split-package-ratchet"),
    ...
    ModuleSizeBudget("tools/darklab_cli/src/darklab_cli/commands/assessment_lifecycle.py", 120, "split-package-ratchet"),
    ModuleSizeBudget(
        "tools/darklab_cli/src/darklab_cli/commands/assessment_lifecycle_formatting.py",
        65,
        "split-package-ratchet",
    ),
    ModuleSizeBudget("tools/darklab_cli/src/darklab_cli/commands/confirmations.py", 36, "split-package-ratchet"),
    ...
    ModuleSizeBudget("tools/darklab_cli/src/darklab_cli/commands/http_profile.py", 27, "split-package-ratchet"),
    ModuleSizeBudget("tools/darklab_cli/src/darklab_cli/commands/http_profile_formatting.py", 52, "split-package-ratchet"),
    ModuleSizeBudget("tools/darklab_cli/src/darklab_cli/commands/http_profile_mutations.py", 83, "split-package-ratchet"),
    ...
    ModuleSizeBudget("tools/darklab_cli/src/darklab_cli/parsers/assessment_lifecycle.py", 45, "split-package-ratchet"),
...
_MODULE_SIZE_RATCHET_REQUIRED_PATTERNS = (
    ...
    "app/services/cve_risk/osv_external*.py",
