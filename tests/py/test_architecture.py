...
_MODULE_SIZE_RATCHET = (
    ...
    ModuleSizeBudget("app/services/assessments/command_plans.py", 104, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/assessments/http_profile_execution.py", 410, "split-package-ratchet"),
