...
_MODULE_SIZE_RATCHET = (
    ...
    ModuleSizeBudget("app/services/connectors/zap_jobs.py", 239, "split-package-ratchet"),
    ...
    ModuleSizeBudget("app/services/connectors/zap_worker.py", 314, "split-package-ratchet"),
