...
function builtInAutocompleteBase() {
  ...
  return {
    ...
    status: emptyBuiltIn('built-in: show the current workspace and access summary, limits, and backend health'),
...
describe('app helpers', () => {
  ...
  it('persists the selected options tab and keeps desktop-only controls in the preferences panel', async () => {
    ...
    expect(document.getElementById('options-tab-access').getAttribute('aria-selected')).toBe('true')
