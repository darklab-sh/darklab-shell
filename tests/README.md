...
The Team panel unit suite holds a list refresh open and checks that the active form, focused field, text selection, and Submit button remain usable. `team-mode.spec.js` types into the focused Team name during a delayed refresh, then exercises creation and invite redemption through real pointer input.
