...
Workspace artifact coverage marks validated Nmap XML intent from separate and attached `-oX` values while rejecting extension guesses, unrelated commands, and ambiguous rewritten paths.
