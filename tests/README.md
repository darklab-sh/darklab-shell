...
| --- | --- |
| Anonymous, portable credential, browser session, OIDC, and fail-closed routing | `test_principal_auth.py`, `test_restricted_access_profile.py`, `test_oidc_sign_in.py`, `test_auth_redirects.py`, `test_browser_session_recovery.py`, `auth-profile-qualification.spec.js` |
