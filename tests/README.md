...
Schemathesis contract coverage keeps local OpenAPI review and generated API traffic inside the reviewed API base URL. It pins strict JSON parsing, internal references, fixed in-scope servers, read-operation and document limits, exact private runtime paths, GET/HEAD-only negative generation, deterministic request bounds, and rejection of direct or drifted commands.
