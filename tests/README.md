...
Dalfox evidence-mode coverage recognizes only the maintained discovery and active command shapes, validates the separate Web 1.5 discovery and validation rules, and proves clean negative evidence from either mode can't satisfy the other mode's check.
