...
Operator navigation, settings controls, and verification/revocation run as independent browser journeys. Access separates credential management, restoration across tabs, and invalid-input checks; restricted sign-out starts both independent browser sessions before testing revocation. The mobile keyboard journey holds the Access module download to verify that interaction waits for the disabled control to become usable. These cases keep the existing timeout limits and CI's flaky-test guard.
