...
Autocomplete readiness coverage checks that a pending startup catalog becomes ready without a competing fetch and that browser checks read the shared app state.
