...
from services.watchers.classifiers.common import list_delta
...
def diff(
    ...
    if conn is None:
        return WatcherDiff(summary={"classifier": "findings", "error": "missing connection"}, kind=DIFF_KIND_NONE)
    ...
    return WatcherDiff(summary=summary, kind=kind, truncated=bool(delta["truncated"]))
