...
MIGRATION = Migration(
    ...
    statements=(
        ...
        """,
        "CREATE INDEX IF NOT EXISTS idx_atlas_import_drafts_expires ON atlas_import_drafts (expires_at)",
        """
        ...
        """,
        "CREATE INDEX IF NOT EXISTS idx_atlas_finding_import_occurrences_batch ON atlas_finding_import_occurrences (batch_id)",
        """
