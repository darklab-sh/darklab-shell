...
function _setRunButtonDisabled(...args) {
  return _callRunnerHandler("_setRunButtonDisabled", void 0, args);
}
...
function startPollingActiveRunsAfterReload(...args) {
  return _callRunnerHandler("startPollingActiveRunsAfterReload", void 0, args);
}
function startTimer(...args) {
  return _callRunnerHandler("startTimer", void 0, args);
}
function stopTimer(...args) {
  return _callRunnerHandler("stopTimer", void 0, args);
}
...
function syncActiveRunTimer(...args) {
  return _callRunnerHandler("syncActiveRunTimer", void 0, args);
}
if (RUNNER_BRIDGE_GLOBAL) {
...
// app/static/js/features/history/history_recall_bridge.js
var HISTORY_RECALL_BRIDGE_GLOBAL = typeof window !== "undefined" ? window : globalThis;
var historyRecallHandlers = HISTORY_RECALL_BRIDGE_GLOBAL.__darklabHistoryRecallHandlers || {
...
function resetCmdHistoryNav(...args) {
  return typeof historyRecallHandlers.resetCmdHistoryNav === "function" ? historyRecallHandlers.resetCmdHistoryNav(...args) : void 0;
}

// app/static/js/welcome_bridge.js
var cancelWelcomeHandler = null;
var requestWelcomeSettleHandler = null;
...
function requestWelcomeSettle(...args) {
  return typeof requestWelcomeSettleHandler === "function" ? requestWelcomeSettleHandler(...args) : void 0;
}
...
(function initSharedUiHelpers(global) {
  ...
  const requestWelcomeSettleFromBridge = (...args) => {
    const settle = typeof requestWelcomeSettle === "function" && requestWelcomeSettle || uiFn("requestWelcomeSettle");
    return typeof settle === "function" ? settle(...args) : void 0;
  };
  const hasPendingTerminalConfirmFromBridge = () => {
    if (typeof hasRunnerHandler === "function" && hasRunnerHandler("hasPendingTerminalConfirm") && typeof hasPendingTerminalConfirm === "function") {
      return !!hasPendingTerminalConfirm();
    }
