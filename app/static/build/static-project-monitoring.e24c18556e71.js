...
(function projectMonitoringModule(global) {
  ...
  function createProjectMonitoringController(context) {
    ...
    function openRunDetails(runId) {
      ...
      const openDetails = typeof openHistoryRunDetails === "function" ? openHistoryRunDetails : typeof global.openHistoryRunDetails === "function" ? global.openHistoryRunDetails : null;
    ...
    function compareRuns(projectId, runId, baselineRunId) {
      ...
      const compareFn = typeof fetchAndRenderHistoryComparison === "function" ? fetchAndRenderHistoryComparison : typeof global.fetchAndRenderHistoryComparison === "function" ? global.fetchAndRenderHistoryComparison : null;
