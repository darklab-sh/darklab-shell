...
// app/static/js/features/projects/project_nested_sheets.js
var exportedDarklabProjectNestedSheets = null;
(function projectNestedSheetsModule(global) {
  ...
  function createProjectNestedSheetsController(context) {
    ...
    function mobileModeActive() {
      return !!(document.body.classList.contains("mobile-terminal-mode") || typeof useMobileTerminalViewportMode === "function" && useMobileTerminalViewportMode());
    }
    function nestedSheetOpen() {
      return !!(ctx.isProjectTargetEditorOpen?.() || ctx.isProjectEntityEditorOpen?.() || ctx.isProjectPackageManifestOpen?.() || ctx.isProjectPackageWizardOpen?.());
    }
