import {
  ...
  toggleRailCollapsed
} from "./static-chunk-etzln663.9aeaf36cd68f.js";
...
} from "./static-chunk-vzfenxxg.b8dadbb5046d.js";
...
function _mobileMenuBlurComposer() {
  const blurComposer = _mobileMenuGlobalFunction("blurVisibleComposerInputIfMobile") || (typeof blurVisibleComposerInputIfMobile === "function" ? blurVisibleComposerInputIfMobile : null);
  if (blurComposer) blurComposer();
}
function _mobileMenuRefocusComposer(options = { defer: true }) {
  const refocusComposer = _mobileMenuGlobalFunction("refocusComposerAfterAction") || (typeof refocusComposerAfterAction === "function" ? refocusComposerAfterAction : null);
...
var closeCommandCatalogModal = (...args) => _controllerFn("closeCommandCatalogModal")?.(...args);
...
var isCommandCatalogOverlayOpen = (...args) => !!_controllerFn("isCommandCatalogOverlayOpen")?.(...args);
...
function _welcomeApi(name) {
  return typeof window !== "undefined" && window[name] || typeof globalThis !== "undefined" && globalThis[name] || (name === "runWelcome" && typeof runWelcome !== "undefined" ? runWelcome : null) || (name === "welcomeOwnsTab" && typeof welcomeOwnsTab !== "undefined" ? welcomeOwnsTab : null) || (name === "requestWelcomeSettle" && typeof requestWelcomeSettle !== "undefined" ? requestWelcomeSettle : null);
}
...
function setupDismissibleOverlays() {
  ...
  bindDismissible(commandCatalogOverlay, {
    ...
    onClose: () => {
      if (typeof closeCommandCatalogModal === "function") closeCommandCatalogModal();
    },
...
document.addEventListener("keydown", (e) => {
  ...
  if (welcomeState.active && typeof activeId !== "undefined" && typeof welcomeOwnsTab === "function" && welcomeOwnsTab(activeId) && typeof requestWelcomeSettle === "function") {
    requestWelcomeSettle(activeId);
  }
...
function _isMajorSurfaceOpenForPromptPaste() {
  return _composerFn("isFaqOverlayOpen")?.() || false || (_composerFn("isOptionsOverlayOpen")?.() || false) || (_composerFn("isThemeOverlayOpen")?.() || false) || (_composerFn("isWorkflowsOverlayOpen")?.() || false) || (_composerFn("isWorkspaceOverlayOpen")?.() || false) || (_composerFn("isHistoryCompareOverlayOpen")?.() || false) || (_composerImportedFn(isHistoryRunOverlayOpen, "isHistoryRunOverlayOpen")?.() || false) || (_composerFn("isHistoryPanelOpen")?.() || false) || (_composerFn("isConfirmOpen")?.() || false);
}
...
cmdInput2.addEventListener("input", () => {
  _composerFn("normalizeComposerSmartPeriod")?.(cmdInput2);
  ...
  _composerFn("handleComposerInputChange")?.(cmdInput2);
...
cmdInput2.addEventListener("keydown", (e) => {
  ...
  if (e.altKey && !e.ctrlKey && !e.metaKey && !e.shiftKey && (isWordArrowLeft || isWordArrowRight)) {
    e.preventDefault();
    e.stopPropagation();
    _composerFn("syncFocusedComposerState")?.(cmdInput2);
...
var importedOpenAtlas;
var importedOpenFindingsBoard;
var importedOpenCommandRegistry;
var importedOpenSchedulesModal;
var importedOpenStatusMonitor;
var importedOpenWatchersModal;
...
(function initShellChrome(global) {
  ...
  railNav?.addEventListener("click", (e) => {
    ...
    const openAtlas2 = _shellFn("openAtlas", importedOpenAtlas);
    ...
    const openCommandRegistry2 = _shellFn("openCommandRegistry", importedOpenCommandRegistry);
    ...
    if (action === "atlas" && typeof openAtlas2 === "function") {
      void openAtlas2({ source: "rail" });
      return;
    }
    ...
    if (action === "command-registry" && typeof openCommandRegistry2 === "function") {
      openCommandRegistry2();
      return;
    }
...
(function initMobileChrome(global) {
  ...
  const restoreHistoryRunIntoTab2 = typeof restoreHistoryRunIntoTab !== "undefined" && restoreHistoryRunIntoTab || null;
  ...
  function _recentsRunActionMenu(run) {
    ...
    addItem("compare", () => {
      if (typeof openHistoryCompareLauncher2 === "function") {
        openHistoryCompareLauncher2(run);
        closeRecentsSheet();
      }
    });
    ...
    _recentsItems.forEach((entryData) => {
      ...
      if (isRun) {
        ...
        actions.appendChild(_recentsMakeAction("restore", () => {
          if (typeof restoreHistoryRunIntoTab2 !== "function") return;
          const cmdEl2 = item.querySelector(".sheet-item-cmd");
          if (cmdEl2) cmdEl2.textContent = "loading…";
          restoreHistoryRunIntoTab2(run, { hidePanelOnSuccess: false }).then(() => closeRecentsSheet()).catch(() => {
      ...
      item.addEventListener("click", (e) => {
        ...
        if (typeof openHistoryRunDetails2 === "function") {
          openHistoryRunDetails2(run);
          closeRecentsSheet();
          return;
        }
