...
var RUNTIME_BRIDGE_GLOBAL = typeof window !== "undefined" ? window : globalThis;
var missingRuntimeHandlersLogged = /* @__PURE__ */ new Set();
var runtimeHandlers = RUNTIME_BRIDGE_GLOBAL.__darklabRuntimeHandlers || {
  apiFetch: null,
  getSessionId: null,
  logClientError: null,
...
function _runtimeBridgeWarningsEnabled() {
  const config = RUNTIME_BRIDGE_GLOBAL?.APP_CONFIG && typeof RUNTIME_BRIDGE_GLOBAL.APP_CONFIG === "object" && !Array.isArray(RUNTIME_BRIDGE_GLOBAL.APP_CONFIG) ? RUNTIME_BRIDGE_GLOBAL.APP_CONFIG : {};
...
function getSessionId() {
  return typeof runtimeHandlers.getSessionId === "function" ? runtimeHandlers.getSessionId() : "";
}
