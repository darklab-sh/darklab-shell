// app/static/js/features/projects/project_workspace_lifecycle.js
var exportedDarklabProjectWorkspaceLifecycle = null;
(function projectWorkspaceLifecycleModule(global) {
  ...
  function createProjectWorkspaceLifecycleController(context) {
    ...
    function summaryFromListRow(project) {
      ...
      const findingSummary = project && project.finding_summary && typeof project.finding_summary === "object" ? project.finding_summary : { review_states: {}, severities: {} };
      return {
        project,
        counts,
    ...
    async function refreshProjectWorkspace() {
      ...
      try {
        ...
        ctx.setProjectRows([]);
        ctx.setProjectSummaries(/* @__PURE__ */ new Map());
