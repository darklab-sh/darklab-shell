...
// app/static/js/features/projects/project_targets.js
var exportedDarklabProjectTargets = null;
  ...
  function createProjectTargetsController(context) {
    ...
    async function saveEditor() {
      ...
      try {
        ...
        const url = targetId ? `/projects/${encodeURIComponent(projectId)}/targets/${encodeURIComponent(targetId)}` : `/projects/${encodeURIComponent(projectId)}/targets`;
