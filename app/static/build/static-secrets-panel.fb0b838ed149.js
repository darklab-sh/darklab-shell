...
function _optionsSecretsAppendLine(...args) {
  const append = typeof appendLine === "function" && appendLine || _optionsSecretsGlobalFunction("appendLine");
  if (append) append(...args);
}
function _optionsSecretsSetStatus(...args) {
  const set = typeof setStatus === "function" && setStatus || _optionsSecretsGlobalFunction("setStatus");
  if (set) set(...args);
}
...
async function _ensureOptionsSecretCatalog(requirements = {}) {
  ...
  try {
    ...
    const logError = typeof logClientError === "function" && logClientError || _optionsSecretsGlobalFunction("logClientError");
