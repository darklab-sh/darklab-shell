...
function _historyProjectRefreshHistoryPanel() {
  const refresh = typeof refreshHistoryPanel !== "undefined" && refreshHistoryPanel || HISTORY_PROJECT_ACTIONS_GLOBAL.refreshHistoryPanel;
...
function _historyEditEntityMetadata(entityType, entity) {
  ...
  editor(entityType, entity, {
    onSaved: async () => {
      const refreshHistoryPanel2 = _historyRowsGlobalFunction("refreshHistoryPanel");
      if (refreshHistoryPanel2) refreshHistoryPanel2();
...
function _historyRestoreTabs() {
  const getTabsFn = _historyRestoreGlobalFunction("getTabs") || typeof getTabs !== "undefined" && getTabs;
...
function _historyRestoreGetTab(tabId) {
  const getTabFn = _historyRestoreGlobalFunction("getTab") || typeof getTab !== "undefined" && getTab;
  return typeof getTabFn === "function" ? getTabFn(tabId) : null;
}
function _historyRestoreGetOutput(tabId) {
  const getOutputForTab = _historyRestoreGlobalFunction("getOutput") || typeof getOutput !== "undefined" && getOutput;
  return typeof getOutputForTab === "function" ? getOutputForTab(tabId) : null;
}
function _historyRestoreCreateTab(label) {
  const create = _historyRestoreGlobalFunction("createTab") || typeof createTab !== "undefined" && createTab;
  return typeof create === "function" ? create(label) : null;
}
function _historyRestoreClearTab(tabId) {
  const clear = _historyRestoreGlobalFunction("clearTab") || typeof clearTab !== "undefined" && clearTab;
  if (typeof clear === "function") clear(tabId);
}
function _historyRestoreAppendLine(text, cls, tabId, metadata = null) {
  const append = _historyRestoreGlobalFunction("appendLine") || typeof appendLine !== "undefined" && appendLine;
  if (typeof append === "function") append(text, cls, tabId, metadata);
}
function _historyRestoreSetTabStatus(tabId, status) {
  const setStatus = _historyRestoreGlobalFunction("setTabStatus") || typeof setTabStatus !== "undefined" && setTabStatus;
...
function _historyRestoreRenderCommandOutcomeSummary(tabId, outcome) {
  const render = _historyRestoreGlobalFunction("renderCommandOutcomeSummary") || typeof renderCommandOutcomeSummary !== "undefined" && renderCommandOutcomeSummary;
...
function _historyHasPendingOutput(tabId) {
  const hasPending = _historyRestoreGlobalFunction("hasPendingOutputBatch") || typeof hasPendingOutputBatch !== "undefined" && hasPendingOutputBatch;
...
var _historyOpenCompareLauncherAdapter = (...args) => _historyFn("openHistoryCompareLauncher", openHistoryCompareLauncher)?.(...args);
...
function _historyMutationRefreshHistoryPanel() {
  const refresh = typeof refreshHistoryPanel !== "undefined" && refreshHistoryPanel || HISTORY_MUTATIONS_GLOBAL.refreshHistoryPanel;
