...
function _historyCompareRendererTabs() {
  const getTabsFn = typeof getTabs === "function" ? getTabs : _historyCompareRendererGlobalFunction("getTabs");
...
function _historyCompareRendererCreateTab(label) {
  const create = typeof createTab !== "undefined" && createTab || _historyCompareRendererGlobalFunction("createTab");
  return typeof create === "function" ? create(label) : null;
}
function _historyCompareRendererActivateTab(tabId, options) {
  const activate = typeof activateTab !== "undefined" && activateTab || _historyCompareRendererGlobalFunction("activateTab");
  if (typeof activate === "function") activate(tabId, options);
}
function _historyCompareRendererRestoreRun(run, options) {
  const restore = typeof restoreHistoryRunIntoTab !== "undefined" && restoreHistoryRunIntoTab || _historyCompareRendererGlobalFunction("restoreHistoryRunIntoTab");
