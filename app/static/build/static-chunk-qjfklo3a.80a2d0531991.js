...
function _historyRunSubmitComposerCommand(command, options) {
  if (typeof submitComposerCommand === "function") {
    const result = submitComposerCommand(command, options);
    if (result !== false) return result;
  }
  const submit = typeof submitComposerCommand2 !== "undefined" && submitComposerCommand2 || _historyRunGlobalFunction("submitComposerCommand");
...
function _historyRunRefreshHistoryPanel() {
  const refresh = typeof refreshHistoryPanel === "function" && refreshHistoryPanel || _historyRunGlobalFunction("refreshHistoryPanel");
