...
export {
  DarklabAutocompleteCore,
  autocompleteRecentValueLimit as RECENT_VALUE_LIMIT,
  autocompleteBoundaryIndex as boundaryIndex,
  autocompleteBuildItem as buildItem,
  autocompleteEscapeHtmlText as escapeHtmlText,
  autocompleteFilterItems as filterItems,
  autocompleteFuzzyMatchIndexes as fuzzyMatchIndexes,
  autocompleteHighlightedLabel as highlightedLabel,
  autocompleteIsDomainValue as isDomainValue,
  autocompleteIsIPv4Address as isIPv4Address,
  autocompleteIsIPv6Address as isIPv6Address,
  autocompleteItemDescription as itemDescription,
  autocompleteItemInsertText as itemInsertText,
  autocompleteItemInsertValue as itemInsertValue,
  autocompleteItemText as itemText,
  autocompleteLimitItemsForDisplay as limitItemsForDisplay,
  autocompleteNormalizeRecentDomain as normalizeRecentDomain,
  autocompleteNormalizeRecentIp as normalizeRecentIp,
  autocompleteNormalizeRecentPortSet as normalizeRecentPortSet,
  autocompleteNormalizeRecentUrl as normalizeRecentUrl,
  autocompleteNormalizeRecentValue as normalizeRecentValue,
  autocompleteNormalizeRecentValueList as normalizeRecentValueList,
  autocompleteNormalizeWordlistCategories as normalizeWordlistCategories,
  autocompleteScoreItem as scoreItem,
  autocompleteSharedPrefix as sharedPrefix,
  autocompleteTokenContextFromText as tokenContextFromText,
};
