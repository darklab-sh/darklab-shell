...
const optionsCommandOutcomeSummariesToggle = document.getElementById('options-command-outcome-summaries-toggle');
...
const optionsPromptUsernameInput = document.getElementById('options-prompt-username-input');
const optionsPromptUsernameError = document.getElementById('options-prompt-username-error');
...
const tabbarChrome = document.getElementById('tabbar-chrome');
const tabbarChromeToggle = document.getElementById('tabbar-chrome-toggle');
...
const workspaceViewerRefreshBtn = document.getElementById('workspace-viewer-refresh-btn');
const workspaceViewerAutoRefreshToggle = document.getElementById('workspace-viewer-auto-refresh-toggle');
const workspaceViewerAutoRefreshLabel = document.getElementById('workspace-viewer-auto-refresh-label');
...
const workspaceLabelsInput = document.getElementById('workspace-labels-input');
...
const commandRegistryOverlay = document.getElementById('command-registry-overlay');
const commandRegistryBody = document.getElementById('command-registry-body');
const commandRegistrySearch = document.getElementById('command-registry-search');
const commandRegistryCategories = document.getElementById('command-registry-categories');
const commandRegistrySubtitle = document.getElementById('command-registry-subtitle');
const commandRegistryCloseBtn = document.querySelector('.command-registry-close');
const commandCatalogOverlay = document.getElementById('command-catalog-overlay');
const commandCatalogBody = document.getElementById('command-catalog-body');
const commandCatalogCloseBtn = document.querySelector('.command-catalog-close');
...
function _publishDomRefs(refs) {
  if (typeof window === 'undefined' || !refs || typeof refs !== 'object') return;
