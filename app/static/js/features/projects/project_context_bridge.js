...
function openProjectAssessment(...args) {
  return typeof projectContextHandlers.openProjectAssessment === 'function'
    ? projectContextHandlers.openProjectAssessment(...args)
    : Promise.resolve(false);
}
