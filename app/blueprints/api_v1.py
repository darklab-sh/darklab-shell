...
def _require_principal_id() -> str:
    """Return the authenticated principal for identity and membership operations."""
    return current_api_session().principal_id
...
from blueprints import api_v1_access as _api_v1_access, api_v1_assessment_action_launch as _api_v1_assessment_action_launch, api_v1_assessment_actions as _api_v1_assessment_actions, api_v1_assessment_batch_mutations as _api_v1_assessment_batch_mutations, api_v1_assessment_batch_previews as _api_v1_assessment_batch_previews, api_v1_assessment_batch_retries as _api_v1_assessment_batch_retries, api_v1_assessment_batches as _api_v1_assessment_batches, api_v1_assessment_checks as _api_v1_assessment_checks, api_v1_assessment_oast as _api_v1_assessment_oast, api_v1_assessment_oast_launch as _api_v1_assessment_oast_launch, api_v1_assessment_zap as _api_v1_assessment_zap, api_v1_assessments as _api_v1_assessments, api_v1_cve_risk as _api_v1_cve_risk, api_v1_finding_evidence as _api_v1_finding_evidence, api_v1_http_profiles as _api_v1_http_profiles, api_v1_manual_findings as _api_v1_manual_findings, api_v1_notifications as _api_v1_notifications, api_v1_osv_lookup as _api_v1_osv_lookup, api_v1_probe_launch as _api_v1_probe_launch, api_v1_probe_targets as _api_v1_probe_targets, api_v1_probes as _api_v1_probes, api_v1_verification_actions as _api_v1_verification_actions  # noqa: E402,F401,E501
...
def __getattr__(name: str):
    for module in (_api_v1_access, _api_v1_assessment_action_launch, _api_v1_assessment_actions, _api_v1_assessment_batch_mutations, _api_v1_assessment_batch_previews, _api_v1_assessment_batch_retries, _api_v1_assessment_batches, _api_v1_assessment_checks, _api_v1_assessment_oast, _api_v1_assessment_oast_launch, _api_v1_assessment_zap, _api_v1_assessments, _api_v1_atlas_lookup, _api_v1_atlas_profile, _api_v1_cve_risk, _api_v1_finding_evidence, _api_v1_http_profiles, _api_v1_manual_findings, _api_v1_notifications, _api_v1_osv_lookup, _api_v1_probe_launch, _api_v1_probe_targets, _api_v1_probes, _api_v1_read, _api_v1_run_evidence, _api_v1_runs, _api_v1_schedules, _api_v1_teams, _api_v1_verification_actions, _api_v1_watchers):  # noqa: E501
