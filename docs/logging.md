...
| DEBUG / ERROR | `PROJECT_PROBE_PROTECTED_CLEANUP_COMPLETED` / `PROJECT_PROBE_PROTECTED_CLEANUP_FAILED` | retryable protected launch-material cleanup; completion is emitted only after confirmed deletion | no contextual fields; raised failure includes traceback |
