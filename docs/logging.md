...
| DEBUG / ERROR | `PROJECT_PROBE_PROTECTED_CLEANUP_COMPLETED` / `PROJECT_PROBE_PROTECTED_CLEANUP_FAILED` | idempotent protected launch-material cleanup | no contextual fields; failure includes traceback |
