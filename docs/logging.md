...
| WARNING | `PROJECT_PROBE_OPERATION_REJECTED` | Project probe service validation or availability rejection | probe_phase, probe_outcome, project_id, entity_id, action_id, protected, error_code; no target value, profile id, command, or private material |
