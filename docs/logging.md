...
| WARNING | `ACTIVE_ASSESSMENT_BATCH_MONITOR_ERROR` | optional owner-scoped Status Monitor batch read | request-safe context and traceback; private session tokens, commands, and targets stay excluded |
