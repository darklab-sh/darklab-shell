...
- The app binds to host loopback by default. Operators can review `.env`, local settings, [raw-packet scanning](#raw-packet-scanning), optional Postgres, optional local AI, and reverse-proxy exposure before starting it.
