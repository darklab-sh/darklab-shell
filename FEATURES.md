...
- Supported formats are Nuclei JSONL, Nessus XML, OWASP ZAP JSON/XML, Burp Suite XML, SARIF 2.1 JSON, CycloneDX JSON, Generic CSV, and Generic JSONL.
