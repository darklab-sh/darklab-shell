...
- Evidence packages are draft project manifests built from selected project material.
  ...
  - Packages record name/description, package labels/notes, transcript/finding/artifact/target selections, redaction mode, artifact inclusion, private-note inclusion, size estimates, artifact warnings, safe project-link provenance, and import hints for future review.
...
- The Monitoring tab gives project users a project-scoped view of scheduled watchers that belong to the project.
