...
- The Report tab turns selected project material into a narrative engagement report.
  ...
  - CVE findings show the KEV/EPSS/CVSS reasons behind their placement. Reports and report manifests pin the public source origins, source and model versions, dates, checksums, attribution, and non-endorsement notice used for that export.
