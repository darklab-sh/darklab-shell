...
- The **Assessment** tab turns saved Project evidence into a practical coverage worklist. Start a maintained Network, Web, API, TLS, or Combined cycle, switch between current and earlier cycles, review covered, awaiting-review, untested, excluded, and unavailable-evidence totals, and narrow checks by category, state, policy level, or evidence availability.
