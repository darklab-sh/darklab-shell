...
- Saved views remember useful Atlas filter sets for the active session token, including the tab, search text, orphan filter, suppression filter, Findings review state, and project scope.
