...
- **Workspace Access replaces session tokens with portable credentials, scoped API tokens, and optional provider sign-in.** Personal data stays with a stable workspace while its credentials and sign-in methods change.
